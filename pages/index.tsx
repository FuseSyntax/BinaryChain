    ...
    <>
      ...
      <section className="relative text-center py-32 bg-gradient-to-br from-emerald-900 via-gray-900 to-emerald-900 overflow-hidden">
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto px-4">
          ...
          <motion.div variants={fadeInUp} className="flex gap-4 justify-center">
            <Link href="/mine" className="group relative bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl flex items-center transition-all duration-300 shadow-lg hover:shadow-emerald-500/20">
      ...
      <section className="relative py-24 px-4 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <motion.div initial="initial" animate="animate" variants={stagger} className="bg-gradient-to-br from-gray-800 to-gray-850 p-8 rounded-3xl border border-gray-700 shadow-2xl">
      ...
      <section className="py-24 px-4 bg-gray-900">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-white mb-8">Live Chain Visualization</h2>
